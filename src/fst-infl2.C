...

{
  ...
  cerr << "Options:\n";
  cerr << "-b:  print analysis as well as surface characters with a colon notation\n";
  cerr << "-e n: robust matching (Print analyses with an edit distance of up to n.)\n";
  cerr << "-% f: disambiguate statistically (print best analyses up to a total probability of f %).\n";
  cerr << "-p:  print probabilities\n";
  cerr << "-t tfile:  alternative transducer (The last transducer should be specified without a preceding -t)\n";
  cerr << "-d:  disambiguate symbolically (print the simplest analyses, should only be used with SMOR)\n";
  cerr << "-delim s: use string s as the delimiter between different analyses\n";
  ...
  cerr << "\n The transducers specified with the -t option are applied in the order in which they appear on the command line. The transducer stored in the first standard file argument is applied last. As soon as a transducer was successful, the others are not tried anymore.\n";
