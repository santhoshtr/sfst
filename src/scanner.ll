...
utf8> \\[\x00-\x7f]        { yylval.value=fst_strdup(yytext+1); return UTF8CHAR; }
utf8> \\[\xc0-\xdf]{CC}    { yylval.value=fst_strdup(yytext+1); return UTF8CHAR; }
utf8> \\[\xe0-\xef]{CC}{2} { yylval.value=fst_strdup(yytext+1); return UTF8CHAR; }
utf8> \\[\xf0-\xff]{CC}{3} { yylval.value=fst_strdup(yytext+1); return UTF8CHAR; }
